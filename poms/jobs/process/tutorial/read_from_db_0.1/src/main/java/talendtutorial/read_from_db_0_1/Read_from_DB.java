...
package talendtutorial.read_from_db_0_1;
...
/**
 * Job: Read_from_DB Purpose: Read data from DB<br>
 ...
 * @status
 */
public class Read_from_DB implements TalendJob {
	...
	private final String jobName = "Read_from_DB";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Read_from_DB.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:u3deF6Z+WI8azneWmpHq+Leu+9R9Sn4yrfn1U7kL7o0=");
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_TALENDTUTORIAL_Read_from_DB = new byte[0];
		static byte[] commonByteArray_TALENDTUTORIAL_Read_from_DB = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TALENDTUTORIAL_Read_from_DB.length) {
					if (length < 1024 && commonByteArray_TALENDTUTORIAL_Read_from_DB.length == 0) {
						commonByteArray_TALENDTUTORIAL_Read_from_DB = new byte[1024];
					} else {
						commonByteArray_TALENDTUTORIAL_Read_from_DB = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TALENDTUTORIAL_Read_from_DB, 0, length);
				strReturn = new String(commonByteArray_TALENDTUTORIAL_Read_from_DB, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TALENDTUTORIAL_Read_from_DB, 0, length);
				strReturn = new String(commonByteArray_TALENDTUTORIAL_Read_from_DB, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TALENDTUTORIAL_Read_from_DB) {
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final Read_from_DB Read_from_DBClass = new Read_from_DB();

		int exitCode = Read_from_DBClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Read_from_DB.class.getClassLoader()
					.getResourceAsStream("talendtutorial/read_from_db_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Read_from_DB.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Read_from_DB");
		}
...
/************************************************************************************************
 * 57700 characters generated by Talend Open Studio for Data Integration on the
 * May 30, 2023, 1:53:37 PM GMT+01:00
 ************************************************************************************************/