...
package talendtutorial.prepared_statement_0_1;
...
/**
 * Job: Prepared_statement Purpose: Read data from DB<br>
 ...
 * @status
 */
public class Prepared_statement implements TalendJob {
	...
	private final String jobName = "Prepared_statement";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Prepared_statement.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Prepared_statement.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:4Rh4yYGuFo7SlFggfWIIdHRxwN2ujZKoFA+xGccMk3k=");
	...
	public static class row5Struct implements routines.system.IPersistableRow<row5Struct> {
		final static byte[] commonByteArrayLock_TALENDTUTORIAL_Prepared_statement = new byte[0];
		static byte[] commonByteArray_TALENDTUTORIAL_Prepared_statement = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TALENDTUTORIAL_Prepared_statement) {
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TALENDTUTORIAL_Prepared_statement.length) {
					if (length < 1024 && commonByteArray_TALENDTUTORIAL_Prepared_statement.length == 0) {
						commonByteArray_TALENDTUTORIAL_Prepared_statement = new byte[1024];
					} else {
						commonByteArray_TALENDTUTORIAL_Prepared_statement = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TALENDTUTORIAL_Prepared_statement, 0, length);
				strReturn = new String(commonByteArray_TALENDTUTORIAL_Prepared_statement, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TALENDTUTORIAL_Prepared_statement, 0, length);
				strReturn = new String(commonByteArray_TALENDTUTORIAL_Prepared_statement, 0, length, utf8Charset);
			}
			return strReturn;
		}
...
// Start of branch "row2"
						if (row2 != null) {
							...
							while (true) {
								...
								row5.resultSet = re_tParseRecordSet_1.getObject("birth_date");
									...
									new javax.mail.Authenticator() {
										protected javax.mail.PasswordAuthentication getPasswordAuthentication() {
											...
											final String decryptedPassword_tSendMail_2 = routines.system.PasswordEncryptUtil
													.decryptPassword(
															"enc:routine.encryption.key.v1:P6JIh2Y6LJx6IcsNcFFDJih/Jr6PyHfSkNaN0QpDZRx6g/4K9vJoN4451u0=");
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final Prepared_statement Prepared_statementClass = new Prepared_statement();

		int exitCode = Prepared_statementClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Prepared_statement.class.getClassLoader().getResourceAsStream(
					"talendtutorial/prepared_statement_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Prepared_statement.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Prepared_statement");
		}
...
/************************************************************************************************
 * 116259 characters generated by Talend Open Studio for Data Integration on the
 * May 30, 2023, 2:02:04 PM GMT+01:00
 ************************************************************************************************/