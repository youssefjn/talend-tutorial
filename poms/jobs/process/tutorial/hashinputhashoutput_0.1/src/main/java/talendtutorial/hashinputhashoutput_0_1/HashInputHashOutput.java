...
package talendtutorial.hashinputhashoutput_0_1;
...
/**
 * Job: HashInputHashOutput Purpose: Java_custom_code<br>
 * Description: Java_custom_code <br>
 * 
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status
 */
public class HashInputHashOutput implements TalendJob {
	...
	private final String jobName = "HashInputHashOutput";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					HashInputHashOutput.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(HashInputHashOutput.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:6wiuPakY9JgYUpu9Z/SgQtfTSxbLekNnsKldOzz6SSI=");
	...
	public static class row9Struct implements routines.system.IPersistableRow<row9Struct> {
		final static byte[] commonByteArrayLock_TALENDTUTORIAL_HashInputHashOutput = new byte[0];
		static byte[] commonByteArray_TALENDTUTORIAL_HashInputHashOutput = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TALENDTUTORIAL_HashInputHashOutput.length) {
					if (length < 1024 && commonByteArray_TALENDTUTORIAL_HashInputHashOutput.length == 0) {
						commonByteArray_TALENDTUTORIAL_HashInputHashOutput = new byte[1024];
					} else {
						commonByteArray_TALENDTUTORIAL_HashInputHashOutput = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TALENDTUTORIAL_HashInputHashOutput, 0, length);
				strReturn = new String(commonByteArray_TALENDTUTORIAL_HashInputHashOutput, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TALENDTUTORIAL_HashInputHashOutput, 0, length);
				strReturn = new String(commonByteArray_TALENDTUTORIAL_HashInputHashOutput, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TALENDTUTORIAL_HashInputHashOutput) {
...
///////////////////////    			
				...
				String hashKey_tHashOutput_1 = "tHashFile_HashInputHashOutput_" + pid + "_tHashOutput_1";
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 1) {
							...
							row8.emp_no = rs_tDBInput_1.getInt(1);
						...
						if (colQtyInRs_tDBInput_1 < 2) {
							...
							if (rs_tDBInput_1.getString(2) != null) {
								...
								if (!("0000-00-00").equals(dateString_tDBInput_1)
									...
									row8.birth_date = rs_tDBInput_1.getTimestamp(2);
								} else {
									row8.birth_date = (java.util.Date) year0_tDBInput_1.clone();
								}
							} else {
								row8.birth_date = null;
							}
						...
						if (colQtyInRs_tDBInput_1 < 3) {
							...
							row8.firstname = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
						}
						if (colQtyInRs_tDBInput_1 < 4) {
							row8.lastname = null;
						} else {

							row8.lastname = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, false);
						}
						if (colQtyInRs_tDBInput_1 < 5) {
							...
							if (tmpContent_tDBInput_1 != null && tmpContent_tDBInput_1.length() > 0) {
								row8.gender = tmpContent_tDBInput_1.charAt(0);
							} else {
						...
						if (colQtyInRs_tDBInput_1 < 6) {
							...
							if (rs_tDBInput_1.getString(6) != null) {
								...
								if (!("0000-00-00").equals(dateString_tDBInput_1)
										&& !("0000-00-00 00:00:00").equals(dateString_tDBInput_1)) {
									row8.hire_date = rs_tDBInput_1.getTimestamp(6);
								} else {
									row8.hire_date = (java.util.Date) year0_tDBInput_1.clone();
								}
							} else {
								row8.hire_date = null;
							}
						...
						oneRow_tHashOutput_1.emp_no = row8.emp_no;
						oneRow_tHashOutput_1.birth_date = row8.birth_date;
						oneRow_tHashOutput_1.firstname = row8.firstname;
						oneRow_tHashOutput_1.lastname = row8.lastname;
						oneRow_tHashOutput_1.gender = row8.gender;
						oneRow_tHashOutput_1.hire_date = row8.hire_date;
...
///////////////////////		
						...
						String[] row_tLogRow_4 = new String[6];

						if (row9.emp_no != null) { //
							row_tLogRow_4[0] = String.valueOf(row9.emp_no);

						} //

						if (row9.birth_date != null) { //
							row_tLogRow_4[1] = FormatterUtils.format_Date(row9.birth_date, "dd-MM-yyyy");

						} //

						if (row9.firstname != null) { //
							row_tLogRow_4[2] = String.valueOf(row9.firstname);

						} //

						if (row9.lastname != null) { //
							row_tLogRow_4[3] = String.valueOf(row9.lastname);

						} //

						if (row9.gender != null) { //
							row_tLogRow_4[4] = String.valueOf(row9.gender);

						} //

						if (row9.hire_date != null) { //
							row_tLogRow_4[5] = FormatterUtils.format_Date(row9.hire_date, "dd-MM-yyyy");
	...
	public void tHashInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_3.setTableName("tLogFromMemory");
...
///////////////////////    			
				...
				org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row8Struct> tHashFile_tHashInput_1 = mf_tHashInput_1
						.getAdvancedMemoryHashFile("tHashFile_HashInputHashOutput_" + pid + "_tHashOutput_1");
				...
				while (iterator_tHashInput_1.hasNext()) {
					...
					row10.emp_no = next_tHashInput_1.emp_no;
					row10.birth_date = next_tHashInput_1.birth_date;
					row10.firstname = next_tHashInput_1.firstname;
					row10.lastname = next_tHashInput_1.lastname;
					row10.gender = next_tHashInput_1.gender;
					row10.hire_date = next_tHashInput_1.hire_date;
...
///////////////////////		
					...
					if (row10.emp_no != null) { //
						row_tLogRow_3[0] = String.valueOf(row10.emp_no);

					} //

					if (row10.birth_date != null) { //
						row_tLogRow_3[1] = FormatterUtils.format_Date(row10.birth_date, "dd-MM-yyyy");

					} //

					if (row10.firstname != null) { //
						row_tLogRow_3[2] = String.valueOf(row10.firstname);

					} //

					if (row10.lastname != null) { //
						row_tLogRow_3[3] = String.valueOf(row10.lastname);

					} //

					if (row10.gender != null) { //
						row_tLogRow_3[4] = String.valueOf(row10.gender);

					} //

					if (row10.hire_date != null) { //
						row_tLogRow_3[5] = FormatterUtils.format_Date(row10.hire_date, "dd-MM-yyyy");
...
///////////////////////    			
				...
				org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap
						.remove("tHashFile_HashInputHashOutput_" + pid + "_tHashOutput_1");
...
///////////////////////		
						...
						if (row3.priority != null) { //
							...
							strBuffer_tLogRow_1.append(String.valueOf(row3.priority));
						...
						if (row3.type != null) { //
							...
							strBuffer_tLogRow_1.append(String.valueOf(row3.type));
...
///////////////////////    			
						...
						String message_tSendMail_1 = (("Error Message:  " + String.valueOf(row4.message) + " Code:  "
									...
									new javax.mail.Authenticator() {
										protected javax.mail.PasswordAuthentication getPasswordAuthentication() {
											...
											final String decryptedPassword_tSendMail_1 = routines.system.PasswordEncryptUtil
													.decryptPassword(
															"enc:routine.encryption.key.v1:rpBJqG0ipSSAkMTFV/GrHBO3ZH8hQUIOvJi2u39b3NyaD6biJO+XZzKSINw=");
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final HashInputHashOutput HashInputHashOutputClass = new HashInputHashOutput();

		int exitCode = HashInputHashOutputClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = HashInputHashOutput.class.getClassLoader().getResourceAsStream(
					"talendtutorial/hashinputhashoutput_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = HashInputHashOutput.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : HashInputHashOutput");
		}
...
/************************************************************************************************
 * 142006 characters generated by Talend Open Studio for Data Integration on the
 * May 31, 2023, 3:04:47 PM GMT+01:00
 ************************************************************************************************/