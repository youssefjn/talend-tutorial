...
package talendtutorial.java_custom_code_0_1;
...
/**
 * Job: Java_custom_code Purpose: Java_custom_code<br>
 ...
 * @status
 */
public class Java_custom_code implements TalendJob {
	...
	private final String jobName = "Java_custom_code";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Java_custom_code.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Java_custom_code.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:PH2ytgiHJOf6bWcqxt3V32w7H1Yw9gKx1jaZDW88HhY=");
	...
	public static class row7Struct implements routines.system.IPersistableRow<row7Struct> {
		final static byte[] commonByteArrayLock_TALENDTUTORIAL_Java_custom_code = new byte[0];
		static byte[] commonByteArray_TALENDTUTORIAL_Java_custom_code = new byte[0];

		public void readData(ObjectInputStream dis) {

			synchronized (commonByteArrayLock_TALENDTUTORIAL_Java_custom_code) {
	...
	public void tJavaFlex_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_2.setTableName("customCodeLog");
...
///////////////////////    			
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tJavaFlex_1:OnSubjobOk", "",
						Thread.currentThread().getId() + "", "", "", "", "", "");
			}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TALENDTUTORIAL_Java_custom_code.length) {
					if (length < 1024 && commonByteArray_TALENDTUTORIAL_Java_custom_code.length == 0) {
						commonByteArray_TALENDTUTORIAL_Java_custom_code = new byte[1024];
					} else {
						commonByteArray_TALENDTUTORIAL_Java_custom_code = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TALENDTUTORIAL_Java_custom_code, 0, length);
				strReturn = new String(commonByteArray_TALENDTUTORIAL_Java_custom_code, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TALENDTUTORIAL_Java_custom_code, 0, length);
				strReturn = new String(commonByteArray_TALENDTUTORIAL_Java_custom_code, 0, length, utf8Charset);
			}
			return strReturn;
		}
...
///////////////////////    			
				...
				java.sql.PreparedStatement pstmt_tDBRow_2 = conn_tDBRow_2.prepareStatement(
						"insert into talend_output (entityId, date_changed) values (?, NOW()) on duplicate key update entityId = values (entityI"
								+ "d),date_changed=values(date_changed)");
...
// ###############################
				...
				util_tLogRow_5.setTableName("printToScreen");
				util_tLogRow_5.addRow(new String[] { "emp_no", "resultSet", });
						...
						if (row2 != null) {
							...
							while (true) {
								...
								if (res_str_tParseRecordSet_1 != null) {
									row6.emp_no = ParserUtils.parseTo_Integer(res_str_tParseRecordSet_1.trim());
								} else {
									// row6.emp_no = ParserUtils.parseTo_Integer(res_str_tParseRecordSet_1);
									row6.emp_no = null;
								}
								row6.resultSet = row2.resultSet;
...
///////////////////////		
								...
								if (row6.emp_no != null) { //
									row_tLogRow_5[0] = String.valueOf(row6.emp_no);

								} //

								if (row6.resultSet != null) { //
									row_tLogRow_5[1] = String.valueOf(row6.resultSet);
...
// Start of branch "talend_output"
								if (talend_output != null) {
									...
									query_tDBRow_2 = "insert into talend_output (entityId, date_changed) values (?, NOW()) on duplicate key update entityId = values (entityI"
											+ "d),date_changed=values(date_changed)";
									...
									if (!whetherReject_tDBRow_2) {
										...
										row9.entityId = talend_output.entityId;

										row9.date_changed = talend_output.date_changed;
...
///////////////////////		
										...
										if (row9.entityId != null) { //
											row_tLogRow_3[0] = String.valueOf(row9.entityId);

										} //

										if (row9.date_changed != null) { //
											row_tLogRow_3[1] = FormatterUtils.format_Date(row9.date_changed,
													"dd-MM-yyyy");
...
///////////////////////    			
						...
						if (execStat) {
							runStat.updateStatOnConnection("iterate1", 1, "exec" + NB_ITERATE_tJavaFlex_2);
							// Thread.sleep(1000);
						}
...
///////////////////////    			
						...
						if (execStat) {
							runStat.updateStatOnConnection("iterate1", 2, "exec" + NB_ITERATE_tJavaFlex_2);
						}
...
// start part of your Java code
				...
				String dbquery_tDBInput_2 = "select  * from employees";
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (colQtyInRs_tDBInput_2 < 1) {
							...
							row10.emp_no = rs_tDBInput_2.getInt(1);
						...
						if (colQtyInRs_tDBInput_2 < 2) {
							...
							if (rs_tDBInput_2.getString(2) != null) {
								...
								if (!("0000-00-00").equals(dateString_tDBInput_2)
									...
									row10.birth_date = rs_tDBInput_2.getTimestamp(2);
								} else {
									row10.birth_date = (java.util.Date) year0_tDBInput_2.clone();
								}
							} else {
								row10.birth_date = null;
							}
						...
						if (colQtyInRs_tDBInput_2 < 3) {
							...
							row10.firstname = routines.system.JDBCUtil.getString(rs_tDBInput_2, 3, false);
						}
						if (colQtyInRs_tDBInput_2 < 4) {
							row10.lastname = null;
						} else {

							row10.lastname = routines.system.JDBCUtil.getString(rs_tDBInput_2, 4, false);
						}
						if (colQtyInRs_tDBInput_2 < 5) {
							...
							if (tmpContent_tDBInput_2 != null && tmpContent_tDBInput_2.length() > 0) {
								row10.gender = tmpContent_tDBInput_2.charAt(0);
							} else {
						...
						if (colQtyInRs_tDBInput_2 < 6) {
							...
							if (rs_tDBInput_2.getString(6) != null) {
								...
								if (!("0000-00-00").equals(dateString_tDBInput_2)
										&& !("0000-00-00 00:00:00").equals(dateString_tDBInput_2)) {
									row10.hire_date = rs_tDBInput_2.getTimestamp(6);
								} else {
									row10.hire_date = (java.util.Date) year0_tDBInput_2.clone();
								}
							} else {
								row10.hire_date = null;
							}
...
// a piece of code executed in the row
// loop
						if (String.valueOf(row10.firstname).contains("azertyyy")) {
									...
									new javax.mail.Authenticator() {
										protected javax.mail.PasswordAuthentication getPasswordAuthentication() {
											...
											final String decryptedPassword_tSendMail_1 = routines.system.PasswordEncryptUtil
													.decryptPassword(
															"enc:routine.encryption.key.v1:DOJ0NtSxPiCEgo3swGj2NR8ZpFcOC+/rs0B3a4FP+tzIasEeyYORyb/zLSg=");
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final Java_custom_code Java_custom_codeClass = new Java_custom_code();

		int exitCode = Java_custom_codeClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Java_custom_code.class.getClassLoader()
					.getResourceAsStream("talendtutorial/java_custom_code_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Java_custom_code.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Java_custom_code");
		}
...
/************************************************************************************************
 * 205463 characters generated by Talend Open Studio for Data Integration on the
 * May 31, 2023, 3:38:54 PM GMT+01:00
 ************************************************************************************************/